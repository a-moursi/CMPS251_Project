...
public class PercentageDiscount extends Discount {
	...
	public String getDetails() {
		...
		return String.format("Discount (Percent(%s) %.2f%% [%s to %s]):", getCode(), percent, getStartDate(),
				getEndDate());
	}
	...
	public String detailsTail() {
		...
		return String.format("Percent(%s) %.2f%% [%s to %s] | Active: %b", getCode(), percent, getStartDate(),
				getEndDate(), isActive());
	}
