...
public class FixedAmountDiscount extends Discount {
	...
	public String getDetails() {
		...
		return String.format("Discount (Fixed(%s) QAR %.2f [%s to %s]):", getCode(), amountQar, getStartDate(),
				getEndDate());
	}
	...
	public String detailsTail() {
		...
		return String.format("Fixed(%s) QAR %.2f [%s to %s] | Active: %b", getCode(), amountQar, getStartDate(),
				getEndDate(), isActive());
	}

	@Override
	public String ActiveDiscounts() {//not complete
